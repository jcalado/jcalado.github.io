...
- **Auto-rerouting** — when _Audio output_ is set to _Auto_, plugging in or removing a headset or Bluetooth device switches the route on the fly. If your selected device disappears mid-session, a toast tells you what happened.
...
- The reflector connection no longer **reconnects in a loop** after a protocol-level error like _Access denied_.
